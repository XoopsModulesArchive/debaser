...
define('_MI_DEBASER_WARNING',
       'F&uuml;r das einwandfreie Funktionieren dieses Moduls kann keine Garantie &uuml;bernommen werden. Dieses Modul befindet sich noch in der Entwicklung, der Einsatz auf Produktionsseiten erfolgt also auf eigene Gefahr.');
define('_MI_DEBASER_AUTHORMSG',
       'debaser ist mein erstes gr&ouml;&szlig;eres Xoops-Modul und enth&auml;lt als solches nat&uuml;rlich alle Anf&auml;ngerfehler. Dank an alle die mir bei der Entwicklung des Moduls geholfen haben und Undank an alle die mich bei der Bitte um Hilfe ignoriert haben ;-).');

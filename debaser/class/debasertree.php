...
class debasertree
{
    ...
    public function getdebaserFirstChild($sel_id, $order= '')
    {
        $arr =array();
    ...
    public function getdebaserFirstChildId($sel_id)
    {
        $idarray =array();
    ...
    public function getdebaserAllChildId($sel_id, $order= '', $idarray = array())
    {
    ...
    public function getdebaserAllParentId($sel_id, $order= '', $idarray = array())
    {
    ...
    public function getdebaserPathFromId($sel_id, $title, $path= '')
    {
    ...
    public function debaserSelBox($title, $order= '', $preset_id=0, $none=0, $sel_name= '', $onchange= '')
    {
        if ($sel_name == '') {
            $sel_name = $this->id;
        }
    ...
    public function getdebaserNicePathFromId($sel_id, $title, $funcURL, $path= '')
    {
    ...
    // the path is delimetered with "/"
    public function getdebaserIdPathFromId($sel_id, $path= '')
    {
    ...
    public function getdebaserAllChild($sel_id=0, $order= '', $parray = array())
    {
        $sql = 'SELECT * FROM ' . $this->table . ' WHERE ' . $this->pid . '=' . $sel_id . '';
        if ($order != '') {
            $sql .= " ORDER BY $order";
    ...
    public function getdebaserChildTreeArray($sel_id=0, $order= '', $parray = array(), $r_prefix= '')
    {

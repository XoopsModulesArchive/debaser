...
Ganz einfach! Wahlweise über <strong>Einzelupload</strong> oder <strong>Batchload</strong>. Mit <strong>Einzelupload</strong> kann man, wie der Name schon sagt, immer nur eine Datei gleichzeitig hochladen. Ihr habt die M&ouml;glichkeit das Formular selber komplett auszuf&uuml;llen oder wenn Ihr euch die Arbeit sparen wollt, lasst das Script dies f&uuml;r Euch erledigen. Bei manchen Dateitypen werden aber nicht alle Informationen ausgelesen. Wie groß die Datei sein darf die hochgeladen werden kann hängt von den Einstellungen in der php.ini ab. Wenn ihr auf der Einschicken-Seite seid, wird euch oben angezeigt, wie groß die Datei sein darf. Wollt Ihr die <strong>Batchload</strong>-Funktion nutzen, müsst ihr erst per ftp eure Dateien in den batchload-Ordner hochladen. Dann geht in die Administration von debaser und klickt auf den <strong>Batchload</strong>-Link. Jede Datei welche sich in diesem Ordner befindet wird in die Datenbank eingefügt, die Datei selber in den upload-Ordner verschoben und umbenannt. Bei beiden Upload-Möglichkeiten könnt ihr wählen, ob die Kategorien automatisch erstellt werden sollen oder ob ihr die Dateien selber in die Kategorien einsortieren wollt. Beim Batchload kann es vorkommen, dass auch Dateien mit unbekannten Mimetypen hinzugef&uuml;gt werden. Sollte dies der Fall sein, werden diese als noch freizugeben markiert. Unter der Freigabemaske k&ouml;nnen dann auch die richtigen Dateierweiterungen zusortiert werden.</li><br />
...
Es gibt die M&ouml;glichkeit noch weitere als die bereits vorhandenen Player einzubinden. In der Administration auf <strong>Player bearbeiten</strong> anklicken. Einen neuen Namen und den Code dazu eingeben und abschicken. An den Stellen wo die Quelle angegeben werden muss, muss die Variable <strong><@mp3file@></strong> eingef&uuml;gt werden. Stellen an die Werte für H&ouml;he, Breite und Autostart stehen, m&uuml;ssen durch die Variablen <strong><@height@>, <@width@> und <@autostart@></strong> gesetzt werden. Benutzt <strong>IMMER</strong> doppelte Anf&uuml;hrungszeichen innerhalb des Player-Codes</li><br />

<li><span style="color:#ff0000; font-weight:bold;">Abspielen von Radio-Streams</span><br />
Ich habe die Funktionalität von iradio 0.5 mit in debaser eingebaut. Geht in die debaser-Administration um die Radio-Sender zu konfigurieren. Ich glaube dieser Teil ist selbsterklärend. Noch eine Anmerkung: Es klappt noch nicht die Funktionen des Multimedia-Players von den Radio-Funktionen zu trennen. D. h. G&auml;ste die den Radioblock benutzen sollen, haben gleichzeitig Zugriff auf den Multimedia-Teil des Moduls.</li><br />

<li><span style="color:#ff0000; font-weight:bold;">Definieren von Multimedia-Formaten</span><br />
Multimedia-Dateien werden anhand ihrer Erweiterung definiert. In der Administration unter <strong>Dateitypen</strong> findet Ihr eine Eingabemaske in der die Informationen eingetragen werden k&ouml;nnen. Die Dateierweiterung darf maximal 4 Zeichen haben (ohne Punkt). Die Applikation bzw. der Name des Formats muss angegeben werden und der Mimetyp der Datei. Der Mimetyp einer Datei besteht immer aus zwei Teilen der mit einem Slash getrennt ist. Wenn mehrere Mimetypen f&uuml;r einen Dateityp vorliegen werden sie mit einem Leerzeichen voneinander getrennt. In der Eingabemaske solltet Ihr auch den Player einstellen, mit dem diese Dateien standardm&auml;&szlig;ig abgespielt werden sollen. Solltet Ihr den Mimetypen einer Datei nicht kennen: Einfach versuchen die Datei hochzuladen. Wenn der Dateityp nicht bekannt sein sollte, wird der Mimetyp dieser Datei auf der Weiterleitungsseite angezeigt.</li><br />
...
<li><span style="color: #006633; font-weight:bold;">Uploadverzeichnis für Kategoriebilder:</span> Hier k&ouml;nnt Ihr festlegen in welchem Verzeichnis die Kategoriebilder abgelegt sind.</li><br />
<li><span style="color: #006633; font-weight:bold;">Thumbnails:</span> Kategoriebilder werden durch die Thumbnails dargestellt. Stellt die Einstellung auf <strong>Nein</strong>, wenn euer Server keine Grafik-Libraries zur Verf&uuml;gung stellt. Unterst&uuml;tzt werden die Grafikformate gif, jpg und png.</li><br />
<li><span style="color: #006633; font-weight:bold;">Maximale Breite der Kategoriebilder</span> Hier k&ouml;nnt ihr festlegen wie breit die Kategoriebilder sein d&uuml;rfen. Funktioniert nur wenn Thumbnails auf <strong>Ja</strong> steht.</li><br />
<li><span style="color: #006633; font-weight:bold;">Maximale H&ouml;he der Kategoriebilder</span> Hier k&ouml;nnt ihr festlegen wie hoch die Kategoriebilder sein d&uuml;rfen. Funktioniert nur wenn Thumbnails auf <strong>Ja</strong> steht.</li><br />
<li><span style="color: #006633; font-weight:bold;">Thumbnail-Qualit&auml;t:</span> Hier k&ouml;nnt ihr festlegen wie hoch die Qualit&auml;t der Kategoriebilder sein soll. Der Wert <strong>100</strong> entspricht der Qualit&auml;t 100 %. Funktioniert nur wenn Thumbnails auf <strong>Ja</strong> steht.</li><br />
<li><span style="color: #006633; font-weight:bold;">Thumbnails-Aktualisierung?</span> Hier k&ouml;nnt Ihr festlegen, ob bei jedem Aufruf der Index-Seite die Kategoriebilder aktualisiert werden sollen. Wenn nein, wird das zuletzt erzeugte Bild benutzt. Funktioniert nur wenn Thumbnails auf <strong>Ja</strong> steht.</li><br />
<li><span style="color: #006633; font-weight:bold;">Seitenverh&auml;ltnis des Kategoriebildes beibehalten?</span> Hier k&ouml;nnt ihr festlegen, ob das Kategoriebild verzerrt werden darf, wenn maximale Breite und maximal H&ouml;he des Kategoriebildes nicht das gleiche Seitenverh&auml;ltnis haben. Funktioniert nur wenn Thumbnails auf <strong>Ja</strong> steht.</li><br />
<li><span style="color: #006633; font-weight:bold;">Berechtigungssystem f&uuml;r Kategorien benutzen?</span> Hier legen Sie fest, ob Sie auf zusätzlichen Administrationsaufwand durch das Berechtigungssystem für Kategorien verzichten wollen und alle Kategorien für alle User sichtbar sind.</li><br />
<li><span style="color: #006633; font-weight:bold;">Berechtigungssystem f&uuml;r Dateien benutzen?</span> Hier legen Sie fest, ob Sie auf zusätzlichen Administrationsaufwand durch das Berechtigungssystem für Dateien verzichten wollen und alle Dateien für alle User sichtbar sind.</li><br />
<li><span style="color: #006633; font-weight:bold;">Playervorauswahl</span> Hier werden die Gruppen festgelegt, die vorgegebene Player benutzen sollen. Somit k&ouml;nnen die User die Player NICHT selber aussuchen. G&auml;ste m&uuml;ssen generell die voreingestellten Player benutzen.</li><br />
<li><span style="color: #006633; font-weight:bold;">Dateien sortieren nach</span> Die Dateien k&ouml;nnen innerhalb der Kategorie nach diversen Kriterien sortiert werden.</li><br />
<li><span style="color: #006633; font-weight:bold;">Reihenfolge der Dateien</span> Die Dateien k&ouml;nnen zus&auml;tzlich zu den zuvor genannten Kriterien noch auf- bzw. absteigend sortiert werden.</li><br />
<li><span style="color: #006633; font-weight:bold;">Kategorien sortieren nach</span> Die Kategorien k&ouml;nnen auf der Indexseite nach diversen Kriterien sortiert werden.</li><br />
<li><span style="color: #006633; font-weight:bold;">Reihenfolge der Kategorien</span> Die Kategorien k&ouml;nnen zus&auml;tzlich zu den zuvor genannten Kriterien noch auf- bzw. absteigend sortiert werden.</li><br />
<li><span style="color: #006633; font-weight:bold;">Tooltips benutzen</span> Mit den Tooltips k&ouml;nnen zu den Links in den Bl&ouml;cken und in genre.php weitere Informationen angezeigt werden.</li><br />
</ol></li><br />

<li><span style="color:#ff0000; font-weight:bold;">&Auml;nderungen in 0.7</span><br />
...
<li><span style="color:#ff0000; font-weight:bold;">&Auml;nderungen in 0.8</span><br />
...
- Komplette &Uuml;berarbeitung des Admin-Bereichs<br />
- Komplette &Uuml;berarbeitung des myDebaser-Bereichs. Es k&ouml;nnen den zur Verf&uuml;gung stehenden Dateiformaten Player zugewiesen werden<br />
- Dateiformate k&ouml;nnen im Admin-Bereich verwaltet werden<br />
- In der Administration k&ouml;nnen Dateien in andere Kategorien verschoben werden<br />
- &Uuml;berfl&uuml;ssige Templates wurden gel&ouml;scht<br />
- Berechtigungen hinzugef&uuml;gt<br />
- Admin kann sich beim Einsenden von unbekannten Dateitypen benachrichtigen lassen<br />
- Kategoriebilder f&uuml;r Hauptkategorien k&ouml;nnen festgelegt werden<br />
</li><br />

<li><span style="color:#ff0000; font-weight:bold;">&Auml;nderungen in 0.9</span><br />
- Kategorien und Dateien k&ouml;nnen nach diversen Kriterien sortiert werden<br />
- Anzahl der Dateien in den Kategorien wird angezeigt<br />
- Block nach Popularit&auml;t hinzugef&uuml;gt<br />
- Vorauswahl von Playern<br />
</li><br />

<li><span style="color:#ff0000; font-weight:bold;">&Auml;nderungen in 0.91</span><br />
- Counter f&uuml;r besuchte Dateien und Downloads<br />
- Neues Popup-Info-Skript<br />
- Bugfixes im Uploadbereich<br />
</li><br />

<li><span style="color:#ff0000; font-weight:bold;">&Auml;nderungen in 0.92</span><br />
- H&ouml;he, Breite und Autostart der Player werden in Player-Administration zus&auml;tzlich festgelegt<br />
- Neue Bl&ouml;cke in denen die Dateien direkt abgespielt werden<br />
- Bugfix maximale Uploadgr&ouml;&szlig;e<br />
- Bugfix Radioadministration, lange Stream-URLS jetzt m&ouml;glich<br />
- Dateityp .wmv hinzugef&uuml;gt
</li><br />

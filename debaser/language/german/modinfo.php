...
define("_MI_DEBASER_GENRES","Zeigt die Kategorien f&uuml;r debaser an");
...
define("_MI_DEBASER_DESC","Multimedia-Player f&uuml;r Xoops 2.x");
...
define('_MI_DEBASER_RATED_DESC','Zeigt die am h&ouml;chsten bewerteten Dateien an');
...
define('_MI_DEBASER_UPLOADDESC','<span style="color:#ff0000;"><em>Gruppen die Dateien einschicken d&uuml;rfen</em></span>');
define('_MI_DEBASER_ANONPOST','5. G&auml;sten erlauben Dateien einzuschicken');
...
define('_MI_DEBASER_MAXSIZE','9. Maximale Einzeluploadgr&ouml;&szlig;e in Bytes');
...
define('_MI_DEBASER_UPSEL','10. Art der Daten&uuml;bermittlung');
define('_MI_DEBASER_UPSELDSC','<span style="color:#ff0000;"><em>Hier wird festgelegt ob Dateien, Links zu Dateien oder beides eingeschickt werden k&ouml;nnen</em></span>');
...
define('_MI_DEBASER_GUESTVOTEDSC','<span style="color:#ff0000;"><em>Hier wird festgelegt ob G&auml;ste Dateien bewerten d&uuml;rfen</em></span>');
define('_MI_DEBASER_AUTOGENRESINGLE','12. Automatische Kategorie-Generierung f&uuml;r Einzeluploads?');
define('_MI_DEBASER_AUTOGENRESINGLEDSC','<span style="color:#ff0000;"><em>Hier legen Sie fest, ob die Kategorien aus den Datei-Informationen generiert werden sollen. Wenn nicht m&uuml;ssen Sie die Kategorien von Hand anlegen</em></span>');
define('_MI_DEBASER_AUTOGENREBATCH','13. Automatische Kategorie-Generierung f&uuml;r Batchloads?');
define('_MI_DEBASER_AUTOGENREBATCHDSC','<span style="color:#ff0000;"><em>Hier legen Sie fest, ob die Kategorien aus den Datei-Informationen generiert werden sollen. Wenn nicht m&uuml;ssen Sie die Kategorien von Hand anlegen</em></span>');
define('_MI_DEBASER_CATEGORYIMG','14. Uploadverzeichnis f&uuml;r Kategoriebilder');
define('_MI_DEBASER_USETHUMBS', '15. Thumbnails:');
define('_MI_DEBASER_USETHUMBSDSC', '<span style="color:#ff0000;"><em>Unterst&uuml;tzte Dateitypen: JPG, GIF, PNG.<br /><br />Thumbnails werden zur Darstellung der Kategoriebilder benutzt. Einstellung \'Nein\' bewirkt, dass das Originalbild benutzt wird, falls der Server diese Option nicht unterst&uuml;tzt.</em></span>');
define('_MI_DEBASER_SHOTWIDTH', '16. Maximale Breite der Kategoriebilder');
define('_MI_DEBASER_SHOTHEIGHT', '17. Maximale H&ouml;he der Kategoriebilder');
define('_MI_DEBASER_SHOTWIDTHDSC', '');
define('_MI_DEBASER_QUALITY', '18. Thumbnail-Qualit&auml;t: ');
define('_MI_DEBASER_IMGUPDATE', '19. Thumbnails aktualisieren?');
define('_MI_DEBASER_IMGUPDATEDSC', '<span style="color:#ff0000;"><em>Falls ausgew&auml;hlt werden die Thumbnails bei jedem Seitenaufruf aktualisiert, anderenfalls wird das letzte Thumbnail benutzt.</em></span>');
define("_MI_DEBASER_KEEPASPECT", "20. Seitenverh&auml;ltnis beibehalten?");
define("_MI_DEBASER_KEEPASPECTDSC", "");
define('_MI_DEBASER_USECATPERM','21. Berechtigungssystem f&uuml;r Kategorien benutzen?');
define('_MI_DEBASER_USECATPERMDSC','<span style="color:#ff0000;"><em>Hier legen Sie fest, ob Sie auf zus&auml;tzlichen Administrationsaufwand durch das Berechtigungssystem f&uuml;r Kategorien verzichten wollen und alle Kategorien f&uuml;r alle User sichtbar sind</em></span>');
define('_MI_DEBASER_USEFILEPERM','22. Berechtigungssystem f&uuml;r Dateien benutzen?');
define('_MI_DEBASER_USEFILEPERMDSC','<span style="color:#ff0000;"><em>Hier legen Sie fest, ob Sie auf zus&auml;tzlichen Administrationsaufwand durch das Berechtigungssystem f&uuml;r Dateien verzichten wollen und alle Dateien f&uuml;r alle User sichtbar sind</em></span>');
define("_MI_DEBASER_PRESELECTPLAY","23. Playervorauswahl");
define("_MI_DEBASER_PRESELECTPLAYDESC","<span style='color:#ff0000;'><em>Hier legen Sie fest, bei welchen Gruppen die vorausgew&auml;hlten Player eingesetzt werden sollen. F&uuml;r G&auml;ste werden auf jeden Fall vorausgew&auml;hlte Player benutzt.</em></span>");
...
define("_MI_DEBASER_USETOOLTIPSDSC","<span style='color:#ff0000;'><em>Hier legen Sie fest, ob in genre.php und den Bl&ouml;cken Tooltips mit weiteren Infos angezeigt werden sollen</em></span>");
define('_MI_DEBASER_ID','ID');
define('_MI_DEBASER_ARTIST','K&uuml;nstler');
...
define("_MI_DEBASER_WARNING", "F&uuml;r das einwandfreie Funktionieren dieses Moduls kann keine Garantie &uuml;bernommen werden. Dieses Modul befindet sich noch in der Entwicklung, der Einsatz auf Produktionsseiten erfolgt also auf eigene Gefahr.");
define("_MI_DEBASER_AUTHORMSG","debaser ist mein erstes gr&ouml;&szlig;eres Xoops-Modul und enth&auml;lt als solches nat&uuml;rlich alle Anf&auml;ngerfehler. Dank an alle die mir bei der Entwicklung des Moduls geholfen haben und Undank an alle die mich bei der Bitte um Hilfe ignoriert haben ;-).");
...
define('_MI_DEBASER_CREDITS','Ich m&ouml;chte mich bei allen Modulentwicklern bedanken, bei denen ich heftigst klauen bzw. lernen durfte. Im Besonderen: "&Uuml;ber dieses Modul" geklaut bei marcan\'s smart-Modulen. "Mimetypen-Management", "Kategorie-Bilder" und Teile von getfile.php geklaut bei diversen wf-modulen. "Admin-Interface" geklaut bei hszalasar\'s Modulen. Ich danke dem getid3-Projekt f&uuml;r ihre Klasse zum Einlesen von Dateiinformationen. Ich danke Mark Lubkowitz und seiner id3-Klasse die mich zu diesem Modul inspiriert hat. Ich danke Bob Janes f&uuml;r seine exoops-Konvertierung von iRadio. Nat&uuml;rlich bedanke ich mich auch bei Predator, chapi, phppp, Marcan, Liquid, gnikalu und Mithrandir f&uuml;r ihre Hilfe. Falls ich jemanden vergessen haben sollte, dann tut es mir leid.');
?>
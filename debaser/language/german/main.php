...
define("_MD_DEBASER_NOFILES","F&uuml;r diese Kategorie liegen keine Dateien vor");

//language defines for upload.php
define("_MD_DEBASER_MAXUPSIZE","Max. Uploadgr&ouml;&szlig;e = ");
...
define("_MD_DEBASER_NORATING", "Sie haben keine Bewertung f&uuml;r diese Datei gew&auml;hlt!");
define("_MD_DEBASER_VOTEONCE", "Bitte stimmen Sie f&uuml;r eine Datei nur einmal ab.");
define("_MD_DEBASER_VOTEAPPRE", "Ihre Stimme wissen wir zu sch&auml;tzen.");
define("_MD_DEBASER_THANKYOU", "Danke das Sie sich Zeit genommen hier auf %s abzustimmen");
define("_MD_DEBASER_UNKNOWNERROR", "FEHLER. Sie werden zur&uuml;ck gebracht!");

//language defines for mydebaser.php
define("_MD_DEBASER_DBUPDATED","Datenbank wurde aktualisiert!");
define("_MD_DEBASER_MYFAVPLAYER","Bitte w&auml;hlen Sie ihren Lieblingsplayer aus:");

//language defines for player.php
define("_MD_DEBASER_NOPLAYERYET","<strong>Sie haben noch keinen Player ausgew&auml;hlt! Stellen Sie Ihren Player im Submen&uuml; Playerauswahl ein.</strong><br /><br />Dieses Fenster schlie&szlig;t sich automatisch.");
...
/* uploadresult.php */
define("_MD_DEBASER_CLOSEWIN","Fenster schlie&szlig;en");
define("_MD_DEBASER_THANKYOUAPPROVE","Vielen Dank f&uuml;r Ihre Einsendung. Ihre Einsendung muss erst noch vom Webmaster freigegeben werden.");
